...
// docs/3.1, docs/1.1 — public, unauthenticated verification portal. As of
// stakeholder-additional-features.md (2026-07-25) the DPO and Ethics clearances verify
// INDEPENDENTLY: a control number or QR token resolves to exactly one track and shows only that
// track's validity/status and control number — no researcher name or any other personal/study
// detail, per docs/3.1's "exposes no personal data beyond clearance validity/status."
                        ...
                        <div className="p-8">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="font-subtitle text-sm text-stone-600 leading-relaxed">
                                    Enter a certificate Control Number — or scan the QR code on a clearance
                                    certificate — to check its authenticity and validity. Data Privacy and
                                    Research Ethics clearances are verified independently.
                                </p>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            id="q"
                                            type="text"
                                            placeholder="DPREQ-2026-000145 or REMIS-2026-000098"
                                            value={data.q}
                                        ...
                                        result.valid ? (
                                            <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-lg flex items-start gap-3">
                                                ...
                                                <div className="text-sm">
                                                    <p className="font-semibold text-emerald-900 mb-2">Valid {result.track_label}</p>
                                                    <dl className="space-y-1 text-emerald-800">
                                                        <div><dt className="inline font-medium">Clearance Type: </dt><dd className="inline">{result.track_label}</dd></div>
                                                        <div><dt className="inline font-medium">Control Number: </dt><dd className="inline">{result.control_number}</dd></div>
                                            ...
                                            <div className="p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                                                ...
                                                <div className="text-sm">
                                                    <p className="font-semibold text-red-900 mb-2">{result.track_label} Expired</p>
