    ...
    public function submitForm1(array $validated, User $applicant): DpreqApplication
    {
        $dpreqApplication = DB::transaction(function () use ($validated, $applicant) {
            $researchApplication = ResearchApplication::create([
                ...
                'recruitment_method' => $validated['recruitment_method'] ?? null,
                'target_participants' => array_values($validated['target_participants'] ?? []),
                ...
                'ethics_checklist' => $validated['ethics_checklist'] ?? null,
                'risk_band' => $validated['risk_band'] ?? null,
                'risk_band_explanation' => $validated['risk_band_explanation'] ?? null,
                'data_classification' => $validated['data_classification'] ?? null,
                'data_storage_method' => $validated['data_storage_method'] ?? null,
                'data_access_persons' => $validated['data_access_persons'] ?? null,
                'data_retention_period' => $validated['data_retention_period'] ?? null,
                'data_disposal_method' => $validated['data_disposal_method'] ?? null,
    ...
    public function updateForm1(DpreqApplication $dpreqApplication, array $validated, User $editor): bool
    {
        return DB::transaction(function () use ($dpreqApplication, $validated, $editor) {
            ...
            $research->fill([
                ...
                'funding_source_type' => $this->resolveChoice($validated, 'funding_source_type'),
                'respondents' => $validated['respondents'],
                'recruitment_method' => $validated['recruitment_method'] ?? $research->recruitment_method,
                'target_participants' => array_values($validated['target_participants'] ?? $research->target_participants ?? []),
                'target_respondent_count' => $validated['target_respondent_count'],
                'data_collection_method' => $this->resolveChoice($validated, 'data_collection_method'),
                'data_capturing_tool' => $this->resolveChoice($validated, 'data_capturing_tool'),
                'target_start_date' => $validated['target_start_date'],
                ...
                'ethics_checklist' => $validated['ethics_checklist'] ?? $research->ethics_checklist,
                'risk_band' => $validated['risk_band'] ?? $research->risk_band,
                'risk_band_explanation' => $validated['risk_band_explanation'] ?? $research->risk_band_explanation,
                'data_classification' => $validated['data_classification'] ?? $research->data_classification,
                'data_storage_method' => $validated['data_storage_method'] ?? $research->data_storage_method,
                'data_access_persons' => $validated['data_access_persons'] ?? $research->data_access_persons,
                'data_retention_period' => $validated['data_retention_period'] ?? $research->data_retention_period,
                'data_disposal_method' => $validated['data_disposal_method'] ?? $research->data_disposal_method,
            ]);
